      ...
      <div class="badan">
          ...
          if (mysql_num_rows($resultselectkereta)==0){
            ...
            <h1 align='center'><font face='Arial Narrow' color='#FF8C00'>
              Dafar Penumpang Kereta Api Stasiun Senen</h1>
            ...
            <td align='center' width = '250'> Tampilkan </td>
            </tr>";
            ...
            <td align='center'><a href ='struk.php?no_kereta=$no_kereta&&no_identitas=$no_identitas'><input type = 'reset' name = 'Reset' value = 'Tampilkan' /></a></td>
            </tr>";
            }
            echo "</table>";
          }
